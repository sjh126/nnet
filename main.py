...
if __name__=="__main__":
    ...
    for epoch in range(opt.niter):
        ...
        while i < len(dataloader):
            ...
            counter = i  + epoch  * len(dataloader)
            Gnerator_iterations.append(counter)
            Wasserstein_estm.append(-errD.data[0].cpu())
...
fig = plt.figure()
plt.plot(Gnerator_iterations, Wasserstein_estm, color='blue')
plt.legend(['Origin Loss'], loc='upper right')
plt.xlabel('Gnerator_iterations')
plt.ylabel('Wasserstein_estm')
#plt.savefig('./images/ddd.png')
plt.show()